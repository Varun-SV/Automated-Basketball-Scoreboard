...
read log for different output video mode.''')
    ...
    videoeditor2 = VideoEditor(
        video_path = "input\\videos\\vid1.mp4", 
        output_path = "output\\videos\\", 
        output_video_name = "vid1_res.mp4",
        highlight_flag = 1, 
        output_mode = 'shot', 
        process_frame_init = 0, 
        process_frame_final = -1, 
        obj_log_name = 'obj_log_name.data', 
        save_step = 2000, 
        weight_path = 'pytorch_YOLOv4/weights/yolov4-basketball.weights', 
        cfg_path = 'pytorch_YOLOv4/cfg/yolov4-basketball.cfg', 
        num_classes = 3, 
        namesfile_path = 'pytorch_YOLOv4/data/basketball_obj.names', 
        inference_detector = 'pytorch', 
        inference_size = '(1184, 1184)', 
        cut_frame = 50)
    # read_flag = 0
