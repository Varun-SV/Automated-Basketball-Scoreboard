...
def angle_between_lines(line1, line2):
    ...
    return abs(angle*180/math.pi)%180
...
def get_straight_hand_coordinates_for_every_person(frame):
    ...
    pose_results, returned_outputs = inference_top_down_pose_model(pose_model, img, person_results, bbox_thr=0.5, format='xyxy', dataset=pose_model.cfg.data.test.type) # inference pose
    ...
    if num_of_persons != 0:
        ...
        for i in persons:
            ...
            if angle_between_lines(l1shouldert2elbow, l2wrist2elbow) ==0 or angle_between_lines(l1shouldert2elbow, l2wrist2elbow) >150:
                templ.append(math.dist(top_portionl,persons[i]['left_wrist'][:2]))
                print("Accuracy : ",persons[i]['left_wrist'][2])
            ...
            if angle_between_lines(r1shouldert2elbow, r2wrist2elbow) > 150 or angle_between_lines(r1shouldert2elbow, r2wrist2elbow)==0:
